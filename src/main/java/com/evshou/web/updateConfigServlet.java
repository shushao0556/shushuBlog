...
@WebServlet(name = "updateConfigServlet",value = "/admin/updateConfig")
public class updateConfigServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        mapper.updateByPrimaryKeySelective(new BlogOptions(null,webTitle,webTitle2,webUrl,web_email));
        ss.commit();
